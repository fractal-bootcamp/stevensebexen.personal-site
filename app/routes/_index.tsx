...
export default function Index() {
  ...
  return (
    <div className="flex flex-col w-screen h-screen max-w-[1024px] m-auto py-4">
      ...
      <div className="grid flex-1 grid-cols-2 grid-rows-2">
        <Link className="mx-4 md:mx-16 my-2 md:my-8 hover:m-2 transition-all duration-200" to="/about">
          <div className="flex items-center w-full h-full bg-red-500 transition-all hover:rounded-3xl drop-shadow-md">
        ...
        <Link className="mx-4 md:mx-16 my-2 md:my-8 hover:m-2 transition-all duration-200" to="/projects">
          <div className="flex items-center w-full h-full bg-cyan-600 transition-all hover:rounded-3xl drop-shadow-md">
